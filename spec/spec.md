...
| **Nguyễn Đức Tâm**<br>(2A202600946) | **Evidence Supporter** | - Thu thập bằng chứng (evidence) hỗ trợ quá trình nghiên cứu và phát triển.<br>- Chuẩn bị tài liệu evidence cho sản phẩm. | - Các file tài liệu bằng chứng đóng góp trong repository |
